...
return [
    ...
    'installer.step.start.content' => '
        ...
        <p>Before you start using the application, please review the <a href="https://github.com/designbymalina/dbmframework" class="link-offset-2 link-offset-3-hover link-underline link-underline-opacity-0 link-underline-opacity-75-hover" target="_blank" rel="noopener noreferrer">DBM Framework documentation</a> powering the platform.</p>
        <ol>
    ...
    'installer.step.authentication.content' => '
        <p>This step will prepare the user authentication system.</p>
        <p>The system will configure the core mechanisms required for:</p>
        <ul>
            <li>User account management</li>
            <li>Sign in and sign out functionality</li>
            <li>Session and security management</li>
            <li>Protection of the administration panel and application resources</li>
        </ul>
        <p>During installation, a default administrator account will be created:</p>
        <ul>
            <li><strong>Administrator</strong></li>
            <li>Login: <strong>Admin</strong> or e-mail: <strong>admin@mail.com</strong></li>
            <li>Password: <strong>Admin@123</strong></li>
        </ul>
        <p><strong>Security recommendation:</strong> change the administrator password after the first login.</p>
        <p>In the future, the authentication system can be extended with additional modules.</p>
    ',
